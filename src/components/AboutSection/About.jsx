        ...
        <div className="flex flex-col lg:flex-row border-white px-4">
          ...
          <div className="w-full lg:w-1/2">
            <div className="flex gap-2 px-6 py-2">
              ...
              <h1 className="text-[#feb901] text-3xl md:text-4xl lg:text-5xl font-medium font-serif">
                I Love
              </h1>
            </div>
            ...
            <div>
              <div className="bg-white flex w-fit m-4 rounded-full p-2">
                <img src={music} alt="" />
                <div className="text-[#619ce4] text-xl md:text-2xl p-3 font-bold font-serif">
                  Listening to music
                </div>
              </div>
              <div className="flex gap-3 flex-wrap">
                ...
                <div className="bg-white p-2 flex w-fit m-4 rounded-full">
                  ...
                  <div className="text-[#6ec17d] text-xl md:text-2xl p-3 font-bold font-serif">
                    Mountains
                  </div>
                </div>
              </div>
              <div className="bg-white flex w-fit m-4 rounded-full p-2">
                <img src={money} alt="" />
                <div className="text-[#06a048] text-xl md:text-2xl p-3 font-bold font-serif">
                  Money
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center w-full lg:w-1/2">
            <div className="bg-[#fddbdb] bg-opacity-5 w-full max-w-xs md:max-w-sm lg:max-w-md rounded-2xl m-5">
              <div className="p-6 flex flex-col gap-1 justify-center items-center">
                <div className="text-[#feb901] text-4xl md:text-5xl lg:text-6xl font-extrabold">
                  14+
                </div>
                <span className="text-white text-3xl md:text-4xl lg:text-5xl font-serif font-medium mt-2">
                  Months
                </span>
                <span className="text-white text-3xl md:text-4xl lg:text-5xl font-serif font-medium py-1">
                  Experience
                </span>
              </div>
            </div>
